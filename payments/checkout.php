...
.button button {
  ...
  .button button i {
   ...
   <div class="container">
    ...
    <div class="price">
        <h1>Awesome, pay total of <br>KES <?php echo number_format($amount); ?><br>to complete your order </h1> 
    </div>
        ...
        <div class="card">
            ...
            <div class="row number">
                <div class="info">
                    ...
                    <input id="cardnumber" type="text" name="phone_number"  placeholder="0700000000" required>
                </div>
            </div>
        </div>
    </div>
